        ...
        <div className="my-4 shadow-sm bg-white shadow rounded p-3">
          <div className="row">
            <div className="col-9 my-auto d-flex flex-column">
              ...
              <small className="primary-color-text">
                <FontAwesomeIcon icon={faPhone} /> {advertisement.employer.phoneNumber}
              </small>
            </div>
            <div className="col-3 my-auto text-center font-weight-light">
              <span>
                <FontAwesomeIcon icon={faMapMarkerAlt} /> {advertisement.city.name}
              </span>
            </div>
          </div>
          <hr />
          <strong className="d-block text-center">
            <h3 className="m-0 font-weight-bold primary-color-text">{advertisement.jobTitle.title}</h3>
            <small className="m-0">
              Diğer <span className="primary-color-text">{advertisement.jobTitle.title}</span> ilanlarını görmek için tıklayabilirsiniz.
            </small>
          </strong>
          <div className="explain-bar">
            <div className="explain-contents">
              <div className="explain-title">Pozisyon Sayısı</div>
              <div className="explain-subtitle">{advertisement.numberOfOpenPositions} Kişi</div>
            </div>
            <div className="explain-contents">
              <div className="explain-title">İş Tipi</div>
              <div className="explain-subtitle">{advertisement.wayOfWorking}</div>
            </div>
            <div className="explain-contents">
              <div className="explain-title">Minimum Ücret</div>
              <div className="explain-subtitle">{advertisement.salaryScale.min} ₺ / Aylık</div>
            </div>
            <div className="explain-contents">
              <div className="explain-title">Maksimum Ücret</div>
              <div className="explain-subtitle">{advertisement.salaryScale.max} ₺ / Aylık</div>
            </div>
          </div>
          <hr />
          ...
          <div className="row">
            <div className="col-12">
              <button className="btn btn-block btn-main d-none bg-primary">
